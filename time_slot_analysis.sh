...
seq 0 $total_timeslots | xargs -n 1 -P $cpu_cores -I{} bash -c "sudo python3 time_slot_analysis_grid.py {} $throughput_degradation"
seq 0 $total_timeslots | xargs -n 1 -P $cpu_cores -I{} bash -c "sudo python3 time_slot_analysis_grid_comparison.py {} $throughput_degradation"
cd .. || exit 1
